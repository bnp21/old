(function(namespace, $) {
	...
	p._initDateTime = function() {
        ...
        $('#demo-date-start2').datetimepicker();
        $('#demo-date-end2').datetimepicker();
        $("#demo-date-start2").on("change.dp", function(e) {
            $('#demo-date-end2').data("DateTimePicker").setStartDate(e.date);
        });
        $("#demo-date-end2").on("change.dp", function(e) {
            $('#demo-date-start2').data("DateTimePicker").setEndDate(e.date);
        });
	};
