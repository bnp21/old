                    ...
                    <div class="box-body">
                        <form class="form-horizontal" role="form" id="notice" method="POST" action="/admin/notice/insertNotice" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-11 col-md-10 col-sm-9">
                                    <span id="delFileArea"><c:if test="${noticeView.filename != '' && noticeView.filename ne null}">${noticeView.filename} <a href="javascript:delAction();">X</a></c:if></span>
                                    <input type="file" name="file" id="file" class="form-control" placeholder="첨부파일" multiple >
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-lg-1 col-md-2 col-sm-3">
        ...
        function loadContent() {
            ...
            /*
             ...
             attachments['image'].push({
                'attacher': 'image',
                'data': {
                    'imageurl': '/resources/front/upload/editor/${noticeView.filename}',
                    'filename': '${noticeView.filename}',
                    'filesize': '${noticeView.filesize}',
                    'originalurl': '/resources/front/upload/editor/${noticeView.filename}',
                    'thumburl': '/resources/front/upload/editor/${noticeView.filename}'
                }
            });*/
            //so@140918 주석
            /*attachments['file'] = [];
            attachments['file'].push({
                'attacher': 'file',
                'data': {
                    'attachurl': '/resources/front/upload/editor/',
