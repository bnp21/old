...
<ol class="breadcrumb">
    <li><a href="/">홈</a></li>
    <li><a href="/">통계</a></li>
    <li class="active">원본 조회수</li>
</ol>
<div class="section-header">
    <h3 class="text-standard"><i class="fa fa-fw fa-arrow-circle-right text-gray-light"></i> 원본 조회수 </h3> <h4><small>'aT생생정보' 원본 방문자 수와 페이지뷰를 알 수 있습니다.</small></h4>
</div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="box table-bordered">
                <div class="box-body">
                    <form id="searchForm" name="searchForm" action="/admin/statistics3/index" method="post">
