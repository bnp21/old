...
<ol class="breadcrumb">
    <li><a href="/">홈</a></li>
    <li><a href="/">통계</a></li>
    <li class="active">메인화면 조회수</li>
</ol>
<div class="section-header">
    <h3 class="text-standard"><i class="fa fa-fw fa-arrow-circle-right text-gray-light"></i> 메인화면 조회수 </h3> <h4><small>'aT생생정보' 메인화면 방문자 수와 페이지뷰를 알 수 있습니다.</small></h4>
</div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="box table-bordered">
                <div class="box-body">
                    <form id="searchForm" name="searchForm" action="/admin/statistics/index" method="post">
        ...
        <div class="col-lg-12">
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="text-left">
                        [용어설명]<br>
                        - 방문자수 : IP별 방문자수 (고유 방문자수입니다. 중복 집계되지 않습니다)<br>
                        - 방문횟수 : 홈페이지 방문자수 (30분 이내 재방문 시에는 집계되지 않습니다.)<br>
                        - 페이지뷰 : 조회수입니다. 중복집계됩니다.
                    </div>
                </div><!--end .box-body -->
            </div><!--end .box -->
